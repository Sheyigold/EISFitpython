...
# The sigma function is used to calculate the effective conductivity of the EIS data.

Rgb_err=fit_perror[:,2]
...
Cb_eff = ebf.C_eff(Rb, Rb_err, Qb, Qb_err, nb, nb_err, T)
Cgb_eff = ebf.C_eff(Rgb, Rgb_err, Qgb, Qgb_err, ngb, ngb_err, T)
